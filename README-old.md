...
Please read README.txt for this project first.
This file you are currently reading is the README file for the original Simplified Secure File Transfer Protocol which I, Ryan Johnston, claim no credit.
I chose to keep this file within the repo as it contains important information to on how to run Simplified-SFTP.
